...
function About() {
  return (
      ...
      <h1>Hi! My name is Saskia, and I am currently studying to become a front-end developer at the Sundsgården folkhögskola: <a href="https://sundsgarden.se/utbildningar-kurser/langa-kurser/distanskurser/it-som-framtidsyrke/" style={{color: 'darkblue', textDecoration: 'none'}}>IT - Front end Developer for women</a>, a fulltime accelerated vocational course.</h1>
