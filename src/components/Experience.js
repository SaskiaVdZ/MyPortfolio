      ...
      <div className="parent">
        <div className="child">
          <ul>
            ...
            <li>2017 &#8212; now </li>
            <li>Preparatory interior architecture & design course online</li>
          </ul>
          <ul>
        ...
        <div className="child">
          ...
          <ul>
            <li>freeCodeCamp</li>
            <li>2023</li>
            <li>Responsive Webdesign Developer Certification</li>
          </ul>
          <ul>
            <li>
              KBT Svealand AB Utbildningcenter för Kognitiv Beteendeterapi
            </li>
            <li>2021</li>
            <li>
              Introduction Course CBT, Cognitive Behavioral Therapy,
              Certification
            </li>
          </ul>
          <ul>
            ...
            <li>1997 &#8212; 2001</li>
            <li>
              Bachelor's degree in Interior Architecture & Spatial Design, 240
              credits, Cum Laude/With Honor
            </li>
          </ul>
          <ul>
          ...
          <ul>
            ...
            <li>2012</li>
            <li>Creative coaching training, Certification</li>
          </ul>
        </div>
      </div>
    </div>
